...
export async function getPackage<T>(
	...
	try {
		...
		// Package is installed but has no default export (e.g. TypeScript 7 removed its CJS entry point).
		// Fall back to resolving package.json to confirm installation.
